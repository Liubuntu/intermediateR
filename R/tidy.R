...
#' @details This approach popularized by Hadley Wickham; see the vignette in the package 'dplyr'
#'
...
#' @return exprs_file character(1) The path to the expression file.
#' @export
#'
